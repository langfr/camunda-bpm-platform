...
create table ACT_RU_TASK (
  ...
  PRIORITY_ integer,
  CREATE_TIME_ datetime year to fraction(5),
  LAST_UPDATED_ datetime year to fraction(5),
...
create table ACT_RU_BATCH (
  ...
  START_TIME_ datetime year to fraction(5),
...
create index ACT_IDX_VARIABLE_TASK_ID_NAME on ACT_RU_VARIABLE(TASK_ID_, NAME_);
...
create index ACT_IDX_EVENT_SUBSCR_ROOT_PROC_ID on ACT_RU_EVENT_SUBSCR(PROC_INST_ID_);
