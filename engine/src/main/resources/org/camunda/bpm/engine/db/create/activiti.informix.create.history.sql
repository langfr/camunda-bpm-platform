...
create table ACT_HI_BATCH (
  ...
  END_TIME_ datetime year to fraction(5),
  REMOVAL_TIME_ datetime year to fraction(5),
  EXEC_START_TIME_ datetime year to fraction(5),
  primary key (ID_)
);
...
create index ACT_IDX_HI_TASK_INST_PROC_DEF_ID on ACT_HI_TASKINST(PROC_DEF_ID_);
...
create index ACT_IDX_HI_IDENT_LNK_PROC_DEF_ID on ACT_HI_IDENTITYLINK(PROC_DEF_ID_);
...
create index ACT_IDX_HI_VAR_INST_TASK on ACT_HI_VARINST(TASK_ID_);
...
create index ACT_IDX_HI_JOB_LOG_JOB_ID on ACT_HI_JOB_LOG(JOB_ID_);
...
create index ACT_IDX_HI_JOB_LOG_JOB_DEF_TYPE on ACT_HI_JOB_LOG(JOB_DEF_TYPE_);
...
create index ACT_IDX_HI_OP_LOG_OP_ID on ACT_HI_OP_LOG(OPERATION_ID_);
